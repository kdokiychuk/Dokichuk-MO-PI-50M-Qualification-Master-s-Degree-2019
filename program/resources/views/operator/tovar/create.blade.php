...
@section('contentPage')
    ...
    <form class="form-horizontal" method="POST" action="{{ url('operator/tovar/create') }}">
        {{csrf_field()}}
        <table class="table table-striped tableView">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{url('operator/users/create')}}" class="btn btn-info">Створити користувача</a>
                </td>
        ...
        <a href="{{ url('operator/tovar/view') }}" class="btn btn-primary">НАЗАД</a> <button type="submit" class="btn btn-primary"> Зберегти </button>
    </form>
