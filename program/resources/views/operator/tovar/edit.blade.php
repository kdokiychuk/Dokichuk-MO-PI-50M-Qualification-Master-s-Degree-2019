...
@section('contentPage')
    ...
    <form action="{{ url('operator/tovar', $masRoleWorkerOne->id_tovar) }}" method="post" class="form-horizontal">
        {{csrf_field()}}
        ...
        <div class="" style="margin-top: 20px; text-align: center;">
            ...
            <a href="{{ url('operator/tovar/view') }}" class="btn btn-primary">НАЗАД</a>
        </div>
    </form>
@endsection