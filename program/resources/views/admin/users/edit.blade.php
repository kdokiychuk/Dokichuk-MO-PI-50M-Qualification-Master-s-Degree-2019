...
@section('contentPage')
    ...
    <form action="{{ url('admin/users', $masRoleWorkerOne->id_users) }}" method="post" class="form-horizontal">
        {{csrf_field()}}
        <div class="">
        ...
        <div class="">
            ...
            <input placeholder="Нова назва" id="text" type="email" class="form-control" name="email" value="{{ $masRoleWorkerOne->email }}">
        </div>
        <div class="">
