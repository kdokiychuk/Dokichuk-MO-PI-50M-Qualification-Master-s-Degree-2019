...
class tovarOperatorController extends Controller
{
    public function view()
    {
        ...
        return view('operator.tovar.view',[
    ...
    public function edit($id_role_worker)
    {
        ...
        return view('operator.tovar.edit',[
    ...
    public function editRecord(Request $request, $id_role_worker)
    {
        ...
        return redirect('operator/tovar/view');
    }
    public function create()
    {
        ...
        return view('operator.tovar.create',[
