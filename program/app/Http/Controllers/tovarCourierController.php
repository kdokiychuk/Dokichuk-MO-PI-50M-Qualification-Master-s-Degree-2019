...
class tovarCourierController extends Controller
{
    public function view()
    {
        ...
        return view('courier.tovar.view',[
    ...
    public function edit($id_role_worker)
    {
        ...
        return view('courier.tovar.edit',[
    ...
    public function editRecord(Request $request, $id_role_worker)
    {
        ...
        return redirect('courier/tovar/view');
    }
    public function create()
    {
        ...
        return view('courier.tovar.create',[
